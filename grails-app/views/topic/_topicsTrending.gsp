<div class="card-subs ">
    <div class="card-header bg-transparent justify-content-between">Trending Topics
        ...
        <div class="d-flex align-items-center">
            <div class="image"><img src="https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=80" class="rounded" width="130"></div>
            <div class="ml-3 w-100">
                <h4 class="  mb-0 mt-0">${t.topicName}</h4> <span class="ml-3">@${t.createdBy.userName}</span>
                <div class="  p-2 mt-2  d-flex justify-content-between rounded  ">
                    ...
                    <button class="btn mt-4 btn-secondary btn-sm subscribe${t.id}" type="button" onclick="subscribe(${t.id})">
                        Subscribe
                    </button>
                ...
                <div class="button mt-2 d-flex flex-row align-items-center justify-content-between">
                    <div class="btn-group">
                        <button class="btn mt-4 btn-secondary btn-sm dropdown-toggle " type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            button 1
                        </button>
    ...
    <g:else>
        <div class="card-body"><span class="align-content-center">Data not Found</span></div>
    </g:else>
