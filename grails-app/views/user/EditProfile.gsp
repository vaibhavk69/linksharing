...
%{--    var deleteTopicUrl = <g:createLink controller="topic" action="allTopics" />--}%
    <script>
                ...
                <div class="col-8 mx-auto my-auto">
                    ...
                    <div class="card-body">
                        <g:form controller="User" action="update" enctype="multipart/form-data">
                            ...
                            <g:textField name="lastName" placeholder="Lastname" value="${session.user.lastName}" class="form-control mb-2"/>
                            <g:textField name="firstName" placeholder="Firstname" value="${session.user.firstName}" class="form-control mb-2"/>
                            <g:textField name="email" placeholder="Email address" value="${session.user.email}" class="form-control mb-2"/>
...
%{--                            <input type="file" accept="image/*" enctype="multipart/form-data">--}%
                            <g:submitButton class="btn btn-success btn-block mt-3 pt-3" name="update" >Update</g:submitButton>
                        </g:form>
